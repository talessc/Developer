...
//  Agenda
//
//  Created by Tales Seixas de Carvalho on 20/08/20.
...
class CalculaMediaAPI: NSObject {
    ...
    func calculaMediaGeralDosAlunos(alunos:Array<Aluno>, sucesso:@escaping(_ didionarioDeMedias: Dictionary<String, Any>)-> Void, falha:@escaping(_ error:Error)-> Void) {
        ...
        do {
            ...
            requisicao.addValue("applicatio/jason", forHTTPHeaderField: "Content-Type")
